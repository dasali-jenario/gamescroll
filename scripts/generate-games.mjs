...
import { wave3Games } from './wave3-games.mjs'
...
`,
  ...
  orbmerge: {
    ...
    function tierR(t) { return TIERS[t].r * S * 1.65 }
    ...
    function drawOrb(x, y, tier, ang) {
      ...
      const g = ctx.createRadialGradient(-r * 0.22, -r * 0.26, r * 0.35, 0, 0, r)
      ...
      ctx.fillStyle = 'rgba(255,255,255,0.1)'
      ctx.beginPath(); ctx.ellipse(-r * 0.22, -r * 0.26, r * 0.38, r * 0.26, -0.35, 0, Math.PI * 2); ctx.fill()
      ctx.restore()
    }
    function draw() {
      ...
      ctx.textAlign = 'left'
      for (const o of orbs) drawOrb(o.x, o.y, o.tier, o.vx * 0.003)
...
Object.assign(games, wave3Games)
